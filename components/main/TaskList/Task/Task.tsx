  ...
  return (
    ...
    >
      ...
      </button>
      {
        isActive
        && (
          <svg className={styles.activeIcon} width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M3.475 2.5L2.5 3.0125V18.0125L3.475 18.5375L14.725 11.0375V10L3.475 2.5V2.5ZM3.75 16.85V4.1875L13.25 10.525L3.75 16.85Z" fill="black" />
            <path fillRule="evenodd" clipRule="evenodd" d="M7.5 18.3536L18.475 11.0373V9.99984L7.5 2.68359V4.18734L17 10.5248L7.5 16.8498V18.3536Z" fill="black" />
          </svg>
        )
      }
