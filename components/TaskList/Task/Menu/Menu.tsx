...
export const Menu = ({ handleEditClick, handleRemoveClick, onClose }: Props) => {
  const ref = useCloseModal({ onClose });

  return (
    <div className={styles.container} ref={ref}>
      <button className={styles.btn} type="button" onClick={handleEditClick}>
      ...
      <button className={styles.btn} type="button" onClick={handleRemoveClick}>
        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
